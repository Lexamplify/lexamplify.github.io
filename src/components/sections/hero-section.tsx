    ...
    <section id="home" className="bg-primary text-white py-28 md:py-48"> 
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 animate-slide-in-up animation-delay-600">
          <Button asChild size="lg" className="text-lg py-3.5 px-8 transition-all duration-300 ease-in-out bg-white hover:bg-neutral-200 text-primary hover:shadow-lg hover:scale-105 group font-body">
            <Link href="#contact">
              <>
                Join Waitlist
